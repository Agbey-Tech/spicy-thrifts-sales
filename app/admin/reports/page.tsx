      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden">
            {/* Card Header */}
            <div className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-6 py-5">
              <div className="flex items-center gap-3">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-semibold hover:from-blue-600 hover:to-cyan-700 transition-all duration-300 hover:shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold hover:from-orange-600 hover:to-red-700 transition-all duration-300 hover:shadow-lg active:scale-95 disabled:opacity-50"
              ...
              {lowStock && (
                <div className="overflow-x-auto">
                  {lowStock.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-full p-6 mb-4">
